...
inline void Statistic::set_key(ArgT0&& arg0, ArgT... args) {
  ...
  has_key_.key_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Statistic::_internal_set_key(const std::string& value) {
  ...
  has_key_.key_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
...
inline std::string* Statistic::release_key() {
  ...
  if (_internal_has_key()) {
    clear_has_has_key();
    return has_key_.key_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
