...
class IncidentsTile_Location final :
 ...
 public:
  ...
  inline IncidentsTile_Location* New() const final {
    return new IncidentsTile_Location();
  }
...
class IncidentsTile_Metadata_Congestion final :
 ...
 public:
  ...
  inline IncidentsTile_Metadata_Congestion* New() const final {
    return new IncidentsTile_Metadata_Congestion();
  }
...
class IncidentsTile_Metadata final :
 ...
 public:
  ...
  inline IncidentsTile_Metadata* New() const final {
    return new IncidentsTile_Metadata();
  }
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_sub_type_description();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_clear_lanes();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_iso_3166_1_alpha2();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_iso_3166_1_alpha3();
  ...
  PROTOBUF_MUST_USE_RESULT ::valhalla::IncidentsTile_Metadata_Congestion* release_congestion();
