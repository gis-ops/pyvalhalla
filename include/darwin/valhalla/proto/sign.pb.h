...
inline void TripSignElement::set_text(ArgT0&& arg0, ArgT... args) {
  ...
  has_text_.text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TripSignElement::_internal_set_text(const std::string& value) {
  ...
  has_text_.text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* TripSignElement::_internal_mutable_text() {
  ...
  return has_text_.text_.Mutable(
...
inline std::string* TripSignElement::release_text() {
  ...
  if (_internal_has_text()) {
    clear_has_has_text();
    return has_text_.text_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
