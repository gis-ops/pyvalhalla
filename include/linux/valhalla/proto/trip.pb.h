...
class TripLeg_Edge final :
 ...
 public:
  ...
  enum : int {
    ...
    kTotalLengthKmFieldNumber = 53,
    kShortcutIdFieldNumber = 54,
  };
  ...
  private:
  bool _internal_has_total_length_km() const;
  public:
  void clear_total_length_km();
  float total_length_km() const;
  void set_total_length_km(float value);
  private:
  float _internal_total_length_km() const;
  void _internal_set_total_length_km(float value);
  public:

  // int64 shortcut_id = 54;
  bool has_shortcut_id() const;
  private:
  bool _internal_has_shortcut_id() const;
  public:
  void clear_shortcut_id();
  int64_t shortcut_id() const;
  void set_shortcut_id(int64_t value);
  private:
  int64_t _internal_shortcut_id() const;
  void _internal_set_shortcut_id(int64_t value);
  public:
 ...
 private:
  ...
  void set_has_total_length_km();
  void set_has_shortcut_id();
  ...
  struct Impl_ {
    ...
    union HasShortcutIdUnion {
      constexpr HasShortcutIdUnion() : _constinit_{} {}
        ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized _constinit_;
      int64_t shortcut_id_;
    } has_shortcut_id_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    uint32_t _oneof_case_[46];
...
// float total_length_km = 53;
inline bool TripLeg_Edge::_internal_has_total_length_km() const {
  return has_total_length_km_case() == kTotalLengthKm;
}
inline bool TripLeg_Edge::has_total_length_km() const {
  return _internal_has_total_length_km();
}
inline void TripLeg_Edge::set_has_total_length_km() {
  _impl_._oneof_case_[44] = kTotalLengthKm;
}
inline void TripLeg_Edge::clear_total_length_km() {
  if (_internal_has_total_length_km()) {
    _impl_.has_total_length_km_.total_length_km_ = 0;
    clear_has_has_total_length_km();
  }
}
inline float TripLeg_Edge::_internal_total_length_km() const {
  if (_internal_has_total_length_km()) {
    return _impl_.has_total_length_km_.total_length_km_;
  }
  return 0;
}
inline void TripLeg_Edge::_internal_set_total_length_km(float value) {
  if (!_internal_has_total_length_km()) {
    clear_has_total_length_km();
    set_has_total_length_km();
  }
  _impl_.has_total_length_km_.total_length_km_ = value;
}
inline float TripLeg_Edge::total_length_km() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Edge.total_length_km)
  return _internal_total_length_km();
}
inline void TripLeg_Edge::set_total_length_km(float value) {
  _internal_set_total_length_km(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.Edge.total_length_km)
}

// int64 shortcut_id = 54;
inline bool TripLeg_Edge::_internal_has_shortcut_id() const {
  return has_shortcut_id_case() == kShortcutId;
}
inline bool TripLeg_Edge::has_shortcut_id() const {
  return _internal_has_shortcut_id();
}
inline void TripLeg_Edge::set_has_shortcut_id() {
  _impl_._oneof_case_[45] = kShortcutId;
}
inline void TripLeg_Edge::clear_shortcut_id() {
  if (_internal_has_shortcut_id()) {
    _impl_.has_shortcut_id_.shortcut_id_ = int64_t{0};
    clear_has_has_shortcut_id();
  }
}
inline int64_t TripLeg_Edge::_internal_shortcut_id() const {
  if (_internal_has_shortcut_id()) {
    return _impl_.has_shortcut_id_.shortcut_id_;
  }
  return int64_t{0};
}
inline void TripLeg_Edge::_internal_set_shortcut_id(int64_t value) {
  if (!_internal_has_shortcut_id()) {
    clear_has_shortcut_id();
    set_has_shortcut_id();
  }
  _impl_.has_shortcut_id_.shortcut_id_ = value;
}
inline int64_t TripLeg_Edge::shortcut_id() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Edge.shortcut_id)
  return _internal_shortcut_id();
}
inline void TripLeg_Edge::set_shortcut_id(int64_t value) {
  _internal_set_shortcut_id(value);
...
inline TripLeg_Edge::HasTotalLengthKmCase TripLeg_Edge::has_total_length_km_case() const {
  return TripLeg_Edge::HasTotalLengthKmCase(_impl_._oneof_case_[44]);
}
inline TripLeg_Edge::HasShortcutIdCase TripLeg_Edge::has_shortcut_id_case() const {
  return TripLeg_Edge::HasShortcutIdCase(_impl_._oneof_case_[45]);
}
// -------------------------------------------------------------------
